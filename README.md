...
![GitHub repo size](https://img.shields.io/github/repo-size/USERNAME/expense-tracker)
![GitHub stars](https://img.shields.io/github/stars/USERNAME/expense-tracker?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/USERNAME/expense-tracker?style=social)
...
| ------------------------- | -------------------------------------------- |
| ![e1](e1.PNG) | **Login Page** – Secure user authentication  |
| ![e2](e2.PNG) | **Signup Page** – Create new account         |
| ![e3](e3.PNG) | **Dashboard** – Cards, charts & analytics    |
